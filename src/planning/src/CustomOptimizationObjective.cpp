...
CustomOptimizationObjective::CustomOptimizationObjective(
    ob::SpaceInformationPtr &si,
    std::shared_ptr<PopulationMap> map_given) : ob::OptimizationObjective(si),
                                                map(map_given)
{
}

ob::Cost CustomOptimizationObjective::stateCost(
...
ob::Cost CustomOptimizationObjective::motionCost(
...
RTreeOptimizationObjective::RTreeOptimizationObjective(
    ob::SpaceInformationPtr &si,
    std::shared_ptr<RTreePoint> rtree_given) : ob::OptimizationObjective(si),
                                               rtree(rtree_given)
{
}
...
ob::Cost RTreeOptimizationObjective::stateCostFast(const ob::State *state) const
{
    const double *pos = state->as<ob::RealVectorStateSpace::StateType>()->values;
...
ob::Cost RTreeOptimizationObjective::motionCost(
    const ob::State *s1, const ob::State *s2) const
{
